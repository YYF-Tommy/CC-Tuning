...
class Trainer:
    ...
    def __init__(
        ...
        self.model_type = model.config.model_type.lower()
    ...
    def _inner_training_loop(
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            step = -1
            for step, inputs in enumerate(epoch_iterator):   # training steps
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        # aux (en)
        occurrence_indices_aux = find_occurrence(inputs["input_ids_aux"], template)
        inputs_pre_aux = {
            "cached_vectors": None,
            "occurrence_indices_aux": occurrence_indices_aux,
            "input_ids": inputs["input_ids_aux"],
        }
        model(**inputs_pre_aux)
        ...
        # non-en
        inputs.pop("input_ids_aux")
        inputs["cached_vectors"] = cached_vectors_aux
        inputs["occurrence_indices_aux"] = None
