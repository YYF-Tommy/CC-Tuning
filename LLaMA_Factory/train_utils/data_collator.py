...
def pad_without_fast_tokenizer_warning(tokenizer, *pad_args, **pad_kwargs):
    ...
    aux = []
    for item in all_col:
        aux.append({"input_ids": item.pop("input_ids_aux")})
    ...
    try:
        ...
        padded = tokenizer.pad(all_col, **pad_kwargs)
        padded_aux = tokenizer.pad(aux, **pad_kwargs)
    finally:
        # Restore the state of the warning.
        tokenizer.deprecation_warnings["Asking-to-pad-a-fast-tokenizer"] = warning_state

    padded["input_ids_aux"] = padded_aux['input_ids']
    return padded
